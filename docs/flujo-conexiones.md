...
<input type="hidden" name="emisor_empresa"   value="{{ empresa_seleccionada.nombre }}">
<input type="hidden" name="emisor_email"     value="{{ usuario_actual.email }}">
<input type="hidden" name="emisor_telefono"  value="{{ usuario_actual.telefono }}">
<input type="hidden" name="emisor_linkedin"  value="{{ usuario_actual.linkedin }}">
<input type="hidden" name="emisor_contacto_preferido" value="{{ usuario_actual.contacto_preferido }}">
...
<input type="hidden" name="token_unico"      value="{{ uuid_generado }}"> <!-- para los botones del email -->
```
